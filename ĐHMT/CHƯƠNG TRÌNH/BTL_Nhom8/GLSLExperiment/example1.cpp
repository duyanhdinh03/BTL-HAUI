...
void ngankeo() {
	//duoi
	model = Translate(0, 0, zKeoTu) * Translate(-0.36, 0.1, 0);
	matPhang(0.4, 0.02, 0.6, model, maungankeo);
	//truoc
	model = Translate(0, 0, zKeoTu) * Translate(-0.36, 0.2, 0.3);
	matPhang(0.4, 0.2, 0.02, model, maungankeo);
	//sau
	model = Translate(0, 0, zKeoTu) * Translate(-0.36, 0.2, -0.3);
	matPhang(0.4, 0.2, 0.02, model, maungankeo);
	//trai
	model = Translate(0, 0, zKeoTu) * Translate(-0.56, 0.2, 0);
	matPhang(0.02, 0.2, 0.6, model, maungankeo);
	//phai
	model = Translate(0, 0, zKeoTu) * Translate(-0.16, 0.2, 0);
	matPhang(0.02, 0.2, 0.6, model, maungankeo);
	// tay nắm ngăn kéo 
...
void manhinh_lap() {
	//màn hình lap 
	model =  RotateX(alpha[2]) * Translate(0, 0, 0.15);
...
void laptop() {
	quayBase = RotateY(theta[0]) * RotateX(theta[1]) * Translate(0.3, 0.61, -4.15);  //0.86
...
void ngantu_trai_duoi() {
	//duoi
	model = Translate(0,0,zKeongantu) * Translate(-0.3, -0.68, 0);
	matPhang(0.6, 0.02, 0.4, model, mautu);
	//truoc
	model = Translate(0, 0, zKeongantu) * Translate(-0.3, -0.5, 0.20);
	matPhang(0.6, 0.38, 0.02, model, mautu);
	//sau
	model = Translate(0, 0, zKeongantu) * Translate(-0.3, -0.5, -0.2);
	matPhang(0.6, 0.38, 0.02, model, mautu);
	//trai
	model = Translate(0, 0, zKeongantu) * Translate(-0.6, -0.5, 0);
	matPhang(0.02, 0.38, 0.4, model, mautu);
	//phai
	model = Translate(0, 0, zKeongantu) * Translate(0, -0.5, 0);
	matPhang(0.02, 0.38, 0.4, model, mautu);
	//num
	model = Translate(0, 0, zKeongantu) * Translate(-0.3, -0.5, 0.25);
	matPhang(0.06, 0.04, 0.02, model, mautuong);
}
